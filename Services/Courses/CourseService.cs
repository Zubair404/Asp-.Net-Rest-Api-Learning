   ...
   public class CourseService : ICourseService
    {
        ...
        {
            return Courses.OrderBy(o => o.Id).Skip(skip).Take(take).ToArray().
            Where(c => string.IsNullOrWhiteSpace(search) || 
            c.Name.Contains(search, StringComparison.InvariantCultureIgnoreCase) || 
            c.Department.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
            c.Professor.FirstName.Contains(search, StringComparison.InvariantCultureIgnoreCase) ||
            c.Professor.LastName.Contains(search, StringComparison.InvariantCultureIgnoreCase)).Skip(skip).Take(take).ToArray();
        }
